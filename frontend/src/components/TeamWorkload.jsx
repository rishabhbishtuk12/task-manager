  ...
  return (
    <div className="rounded-lg border border-[#e5eaf2] bg-white p-5">
      ...
      <p className="mt-1 text-sm text-[#667085]">
        People with active assignments.
      </p>
        ...
        {team.map(member => (
          ...
          >
            <div className="flex min-w-0 items-center gap-3">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#eef4ff] text-sm font-bold text-[#246bfe]">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-sm text-[#667085] capitalize">
                  {member.role}
                </p>
              </div>
            </div>
            <span className="rounded-lg bg-[#f5f7fb] px-3 py-1.5 text-sm font-bold text-[#344054]">
              {member.pendingTasks + member.inProgressTasks || 0}
            </span>
          </div>
        ))}
      </div>
